...
echo ""
cp `rospack find rm_bringup`/scripts/auto_start/rosbag_record_service.sh /home/dynamicx
cp `rospack find rm_bringup`/scripts/auto_start/memory_monitor.sh /home/dynamicx
chmod 777 /home/dynamicx/rosbag_record_service.sh
...
echo ""
sudo systemctl enable rosbag_record_service.service
