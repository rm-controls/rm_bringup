...
echo ""
cp `rospack find rm_bringup`/scripts/auto_start/camera_rosbag_record_service.sh /home/dynamicx
cp `rospack find rm_bringup`/scripts/auto_start/memory_monitor.sh /home/dynamicx
chmod 777 /home/dynamicx/camera_rosbag_record_service.sh
chmod 777 /home/dynamicx/memory_monitor.sh
echo " "
echo "Start to copy service files to /lib/systemd/system/"
echo ""
sudo cp `rospack find rm_bringup`/scripts/auto_start/camera_rosbag_record_service.service  /lib/systemd/system/
...
echo ""
sudo systemctl enable camera_rosbag_record_service.service
